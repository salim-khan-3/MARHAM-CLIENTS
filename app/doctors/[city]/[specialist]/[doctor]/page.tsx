              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                  <div className="bg-slate-50 p-3 rounded-2xl">
                    ...
                    <p className="text-lg font-bold text-slate-800">{doctor.experience} Years</p>
                  </div>
                  <div className="bg-amber-50 p-3 rounded-2xl">
                    <p className="text-xs text-amber-600 font-bold uppercase">Satisfaction</p>
                    <p className="text-lg font-bold text-amber-700">{doctor.satisfaction}% ({doctor.reviews})</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-emerald-100 overflow-hidden sticky top-8">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-emerald-900">Video Consultation</p>
                      <p className="text-xs text-emerald-600">Secure & Private</p>
                    </div>
                  </div>
                ...
                <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-4 rounded-2xl font-bold text-lg shadow-lg shadow-emerald-200 transition-all flex items-center justify-center gap-2">
              ...
              <div className="bg-gray-50 p-4 text-center border-t">
                <p className="text-xs text-gray-500 font-medium">100% Secure Payment & Instant Confirmation</p>
              </div>
            </div>
